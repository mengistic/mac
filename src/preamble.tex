...
\declaretheorem{example}[name={Example},style=mdExercise, numberwithin=section]
\declaretheorem{exercise}[name={Exercise},style=mdExercise, sibling=example]
...
% <==
% ==> enumerate
%define a new counter (need "enumitem" package)
\setlist[enumerate,1]{
	leftmargin=*,
	label={[\arabic*]},
	font=\bfseries,
